# -*- encoding: utf-8 -*-
# stub: github_api 0.10.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<multi_json>, ["~> 1.4"])
      ...
      s.add_development_dependency(%q<coveralls>, ["~> 0.5.8"])
      ...
      s.add_dependency(%q<coveralls>, ["~> 0.5.8"])
