...
version :: {<img src="https://badge.fury.io/rb/youtube_dlhelper.png" alt="version">}[http://rubygems.org/gems/youtube_dlhelper]
...
documentation :: http://rubydoc.info/github/saigkill/youtube_dlhelper/master/frames
...
ohloh2 :: {<script type="text/javascript" src="http://www.ohloh.net/p/712620/widgets/project_thin_badge.js"></script>}[https://www.ohloh.net/p/youtube_dlhelper]
...
{<script type="text/javascript" src="http://www.ohloh.net/p/712620/widgets/project_users.js?style=green"></script>}[https://www.ohloh.net/p/youtube_dlhelper]
