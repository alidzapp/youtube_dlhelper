...
All needed Soft dependencies are delivered with a vendor directory.

== Usage
youtube_dlhelper.rb YoutubeURL or
bin/youtube_dlhelper YoutubeURL


Example:

    youtube_dlhelper.rb http://www.youtube.com/watch?v=aHjpOzsQ9YI
